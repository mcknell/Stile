...
namespace Stile.Tests.Prototypes.Specifications.Printable.DSL.ExpressionBuilders.ResultIs
{
	...
	public class IsStringExtensionsFixture
	{
		...
		private void AssertInstrumentedStringFunction(
			Func<IIs<string, string, IFluentSpecification<string, string>>, IFluentSpecification<string, string>> func,
			string s)
		{
			INegatableIs
				<string, string, IIs<string, string, IFluentSpecification<string, string>>, IFluentSpecification<string, string>>
				instrumentedNegatableIs = Specify.ForAny<string>().That(x => x.ToLowerInvariant()).Is;
		...
		private void AssertStringFunction(
			Func<IIs<string, string, IFluentSpecification<string, string>>, IFluentSpecification<string, string>> func,
			string s)
		{
			INegatableIs
				<string, string, IIs<string, string, IFluentSpecification<string, string>>, IFluentSpecification<string, string>>
				negatableIs = Specify.ThatAny<string>().Is;
