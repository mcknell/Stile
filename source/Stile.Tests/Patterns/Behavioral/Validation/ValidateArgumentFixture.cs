...
namespace Stile.Tests.Patterns.Behavioral.Validation
{
    ...
    public class ValidateArgumentFixture
    {
        ...
        public void IsNotNull()
        {
            ...
            string message = AssertThrows(() => ReferenceArgumentNull_MultipleArgumentsOfSameType(null, new EventArgs()), ", validated at line");
        ...
        private static string AssertThrows<TException>(TestDelegate testDelegate, string substring) where TException: Exception
        {
