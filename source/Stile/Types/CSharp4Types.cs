...
// ReSharper disable MemberCanBePrivate.Global
		...
		static CSharp4Types()
		{
			...
			SimpleTypes =
				new HashSet<Type>(
					EnumUnderlyingTypes.Union(new[]
					{typeof(char), typeof(float), typeof(double), typeof(decimal), typeof(bool)}));
			...
			IntuitivePrimitives =
				new HashSet<Type>(
					Primitives.Union(new[] {typeof(DateTime), typeof(string), typeof(Type), typeof(Expression)})
						.Union(RootTypes));
