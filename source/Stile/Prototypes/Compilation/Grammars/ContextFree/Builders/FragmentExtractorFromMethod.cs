...
namespace Stile.Prototypes.Compilation.Grammars.ContextFree.Builders
{
	public class FragmentExtractorFromMethod :
		ExtractorFromMethod<RuleExpansionAttribute, IReadOnlyList<IFragment>>
	{
		public FragmentExtractorFromMethod(MethodBase methodBase, RuleExpansionAttribute attribute)
