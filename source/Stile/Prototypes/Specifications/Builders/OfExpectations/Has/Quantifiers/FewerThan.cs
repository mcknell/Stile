...
{
	public interface IFewerThan<out TSpecification, TSubject, TResult, TItem> :
		ICountedLimit<TSpecification, TSubject, TResult, TItem>
		where TSpecification : class, ISpecification, IChainableSpecification {}

	public class FewerThan<TSpecification, TSubject, TResult, TItem> :
		CountedLimit<TSpecification, TSubject, TResult, TItem>,
		IFewerThan<TSpecification, TSubject, TResult, TItem>
		where TSpecification : class, ISpecification, IChainableSpecification
		where TResult : class, IEnumerable<TItem>
	{
		public FewerThan([NotNull] IHasState<TSpecification, TSubject, TResult> hasState, int limit)
			: base(hasState, limit) {}
