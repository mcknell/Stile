...
{
	public interface IMoreThan<out TSpecification, TSubject, TResult, TItem> :
		ICountedLimit<TSpecification, TSubject, TResult, TItem>
		where TSpecification : class, ISpecification, IChainableSpecification {}

	public class MoreThan<TSpecification, TSubject, TResult, TItem> :
		CountedLimit<TSpecification, TSubject, TResult, TItem>,
		IMoreThan<TSpecification, TSubject, TResult, TItem>
		where TSpecification : class, ISpecification, IChainableSpecification
		where TResult : class, IEnumerable<TItem>
	{
		public MoreThan([NotNull] IHasState<TSpecification, TSubject, TResult> hasState, int limit)
			: base(hasState, limit) {}
