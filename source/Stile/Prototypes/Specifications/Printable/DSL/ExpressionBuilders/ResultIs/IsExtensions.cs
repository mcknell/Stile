...
namespace Stile.Prototypes.Specifications.Printable.DSL.ExpressionBuilders.ResultIs
{
    public static class IsExtensions
    {
        ...
        [Pure]
        public static IPrintableSpecification<TSubject, TResult> EqualTo<TSubject, TResult>(this IPrintableIs<TSubject, TResult> builder,
        ...
        [Pure]
        public static IPrintableSpecification<TSubject, bool> False<TSubject>(this IPrintableIs<TSubject, bool> builder)
        {
        ...
        [Pure]
        public static IPrintableSpecification<TSubject, TResult> Make<TSubject, TResult>(IPrintableIs<TSubject, TResult> builder,
        ...
        [Pure]
        public static IPrintableSpecification<TSubject, TResult> Null<TSubject, TResult>(this IPrintableIs<TSubject, TResult> builder)
            where TResult : class
        {
            var state = (IIsState<TSubject, TResult>) builder;
        ...
        [Pure]
        public static IPrintableSpecification<TSubject, bool> True<TSubject>(this IPrintableIs<TSubject, bool> builder)
        {
            var state = (IIsState<TSubject, bool>) builder;
            Predicate<bool> accepter = x => state.Negated.AgreesWith(x);
